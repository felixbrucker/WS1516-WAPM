...
\newacronym{CE}{Control Element}
\newacronym{FE}{Forwarding Element}
\newacronym{ONF}{Open Network Foundation}
\newacronym{acl}{ACL}{Access Control List}
\newacronym{AS}{Autonomous System}
